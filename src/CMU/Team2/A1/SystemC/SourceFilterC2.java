...
public class SourceFilterC2 extends FilterFramework {
	// / Name of the source file
	private String fileName = "subSetA.dat";

	/**
	 * Default constructor
	 */
	public SourceFilterC2() {
		super(1, 1);
	}

	/**
	 * Constructor with the input file name as parameter
	 * 
	 * @param fileName
	 *            input file name
	 */
	public SourceFilterC2(String fileName) {
		super(1, 1);
